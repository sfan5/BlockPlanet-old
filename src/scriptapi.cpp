...
static ContentFeatures read_content_features(lua_State *L, int index)
{
	...
	// For selection boxes that are smaller than the node:
	// Set node_abovesurface to the neighbor instead of the node itself.
	getboolfield(L, index, "fencelike_building", f.fencelike_building);
